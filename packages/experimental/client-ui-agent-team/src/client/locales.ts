...
export const tr = {
  'trigger': 'Ajan Takımı',
  'refresh': 'Takımı Yenile',
  'close': 'Kapat',
  'loading': 'Takım yükleniyor…',
  'empty': 'Henüz ortak görev yok',
  'roster': 'Üyeler',
  'tasks': 'Ortak görevler',
  'model': 'Model',
  'open': 'Takım arkadaşı konuşmasını aç',
  'create': 'Yeni görev',
  'subject': 'Görev konusu',
  'description': 'Görev açıklaması',
  'blockers': 'Engelleyen görev kimlikleri (virgülle ayrılmış)',
  'scopes': 'Yazma kapsamları (virgülle ayrılmış)',
  'save': 'Kaydet',
  'cancel': 'Vazgeç',
  'edit': 'Düzenle',
  'complete': 'Tamamla',
  ...
  'writeScopes': 'Yazma kapsamları',
  'ready': 'Hazır',
  'blocked': 'Bağımlılıklar tarafından engelleniyor',
  'conflict': 'Görev durumu değişti ve yeniden yüklendi. Yeniden denemeden önce gözden geçirin.',
  'memberStatus.running': 'Çalışıyor',
  'memberStatus.idle': 'Boşta',
  'memberStatus.inactive': 'Etkin değil',
  'memberStatus.provisioning': 'Hazırlanıyor',
  'memberStatus.failed': 'Başarısız',
