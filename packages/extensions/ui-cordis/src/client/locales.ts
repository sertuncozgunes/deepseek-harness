...
export const tr= {
  ...
  'row.runTitle': 'Cordis Eklentisini Çalıştır',
  'row.updateTitle': 'Cordis Eklentisini Güncelle',
  'row.stopTitle': 'Cordis Eklentisini Durdur',
  'row.removeTitle': 'Cordis Eklentisini Kaldır',
  'purpose.missing': '(amaç belirtilmemiş)',
  'status.idle': 'Hazır',
  'status.awaitingApproval': 'Onay bekleniyor',
  'status.failed': 'Çalıştırma başarısız',
  'status.clientPending': 'İstemci etkinleştirmeye hazır',
  'status.running': 'Çalışıyor',
  'status.removed': 'Kaldırıldı',
  'status.superseded': 'Daha yeni bir çalıştırma mevcut',
  'run.removed': 'Bu paket artık yok',
  'run.superseded': 'Aşağıda daha yeni bir çalıştırma kartı var',
  'panel.hint': "Çalıştırma kontrolleri Ayarlar'ın üzerindeki Cordis panelinde",
  'panel.plugins.aria': 'Cordis eklentileri',
  'panel.approvals.aria': 'Cordis onayları',
  'panel.trigger': 'Cordis Eklentisi',
  'panel.runningCount': '{count} çalışıyor',
  ...
  'panel.next': 'Sıradaki: {packageId}',
  'action.approve': 'İzin ver',
  'action.approveOnce': 'Yalnızca bu sürüme izin ver',
  'action.approvePlugin': 'Bu eklentinin gelecek sürümlerine izin ver',
  ...
  'render.failedAbdicated': '{slot} içinde işleme başarısız; varsayılan arayüz geri yüklendi:',
  'render.failedHeld': '{slot} içinde işleme başarısız:',
