...
export const tr= {
  ...
  'deleteDescription': '{provider} silindiğinde yapılandırması kaldırılır. Kullandığı kimlik bilgileri başka yerde yönetilir ve korunur.',
  ...
  'loadFailed': 'Sağlayıcı dizini yüklenemedi',
  'conflict': 'Bu kart açıkken bu ayarlar başka biri tarafından değiştirildi. Güncel değerler üzerinde düzenlemek için kapatıp yeniden açın.',
  'retry': 'Yeniden dene',
  'keyInput': 'API anahtarı',
  'keyPlaceholder': 'API anahtarınızı girin',
  'keyPlaceholderNative': 'API anahtarı girin ya da ortam kimlik doğrulamasını kullanmak için boş bırakın',
  'keyStored': 'Yapılandırıldı — değiştirmek için yeni bir değer girin',
  'keyEnvLocked': 'Başlatma ortamı tarafından sağlanıyor (salt okunur)',
  'customized': 'Özelleştirilmiş ayarlar',
  'baseUrl': 'Temel URL',
  'baseUrlDefault': 'Sağlayıcı varsayılanı',
  'models': 'Modeller',
  'modelsInherited': 'Adaptör varsayılanları kullanılıyor',
  'modelsCustomized': 'Özelleştirilmiş model kataloğu',
  'resetModels': 'Varsayılanları geri yükle',
  'model': 'Model',
  'modelId': 'Model kimliği',
  'modelName': 'Görünen ad',
  'modelNamePlaceholder': 'Boşsa model kimliği kullanılır',
  'contextWindow': 'Bağlam penceresi',
  'contextWindowPlaceholder': 'Sağlayıcı varsayılanı kullanılır',
  'maxTokens': 'Maks. çıktı tokenı',
  'maxTokensPlaceholder': 'Sağlayıcı varsayılanı kullanılır',
  'modelAdvanced': 'Kapasiteler',
  'addModel': 'Model ekle',
  'removeModel': 'Modeli sil',
  'modelsEmpty': 'Seçicide hiç model gösterilmeyecek. Listede olmayan kimlikler yine de doğrudan gönderilebilir.',
  'keyBlank': 'API anahtarını girin ya da saklanan anahtarı korumak için boş bırakın.',
  'keyBlankNew': 'API anahtarını girin; bu sağlayıcı başka bir yolla kimlik doğruluyorsa boş bırakın.',
  ...
  'modelIdDuplicate': 'Model kimliği benzersiz olmalıdır.',
  'modelNameInvalid': 'Görünen ad boş olamaz.',
  'modelContextInvalid': 'Bağlam penceresi 131072, 256K veya 1M gibi pozitif bir sayı olmalıdır.',
  'modelMaxTokensInvalid': 'Maks. çıktı tokenı 8192, 64K veya 1M gibi pozitif bir sayı olmalıdır.',
  'advancedHint': 'Diğer alanlar settings.yaml içinde; ilgili bölümü doğrudan düzenleyin.',
  'modelCapacityInvalid': 'Kapasite bir sayı olmalı; isteğe bağlı K veya M son eki alabilir.',
  'modelDuplicate': 'Her model kimliği yalnızca bir kez görünebilir.',
  'modelContextWindow': 'Bağlam penceresi',
  'modelMaxTokens': 'Maks. çıktı tokenı',
  'fetchModels': 'Kullanılabilir modelleri getir',
  'fetching': 'Sağlayıcıya soruluyor…',
  'fetchNeedsBaseUrl': 'Önce temel URL girin, sonra getirin.',
  'fetchEmpty': 'Sağlayıcı hiç model listelemedi. Elle ekleyin.',
  'fetchTitle': 'Eklenecek modelleri seçin',
  'fetchDescription': 'Bu sağlayıcının kullanılabilir modelleri bunlar. Eklenecekleri seçin.',
  'fetchSearch': 'Model ara',
  'fetchNoMatches': 'Eşleşen model yok.',
  'fetchSelectAll': 'Tümünü seç',
  'fetchDeselectAll': 'Tüm seçimi kaldır',
  'fetchAdopt': 'Seçilenleri ekle',
  'customAdd': 'Özel sağlayıcı ekle',
  'customTitle': 'Özel sağlayıcı',
  'customTag': 'Özel',
  'customRoute': 'Sağlayıcı kimliği',
  'customRouteHint': 'İsteklerde ve kimlik bilgisi adı olarak bu sağlayıcıyı benzersiz biçimde adlandıran, harfle başlayan küçük harfli tanımlayıcı.',
  'customRouteInvalid': 'Küçük harfle başlayın; sonrasında küçük harf, rakam ve kısa çizgi kullanılabilir.',
  'customRouteTaken': 'Bu kimliği kullanan bir sağlayıcı zaten var.',
  'customDisplayName': 'Görünen ad',
  'customApi': 'API protokolü',
  'customApiUnset': 'Seçilmedi',
  'customNeedsBaseUrl': "Özel bir sağlayıcının temel URL'ye ihtiyacı var.",
  'customBaseUrlInvalid': 'Geçerli bir HTTP veya HTTPS adresi girin.',
  'customNeedsModels': 'Özel bir sağlayıcının en az bir modele ihtiyacı var.',
  'customBaseUrlPlaceholder': 'https://gateway.example/v1',
  'settingsPathUnresolvable': 'çözümlenemeyen ayar yolu',
  'create': 'Sağlayıcı oluştur',
  'creating': 'Oluşturuluyor…',
  'welcomeTitle': 'İç Test Bildirimi',
  'welcomeBody': "DeepSeek Harness 0.1, Harness geliştiricileri için test aşamasındadır. Pek çok alanın daha fazla iyileştirilmesi gerekiyor ve geliştirici topluluğundan geri bildirim almaktan memnuniyet duyarız. DeepSeek Harness'in çekirdek eklentileri ve temel API'leri önümüzdeki aylarda hızla gelişmeye devam edecek.\n\nAçık kaynaklı, açık, yeniden kullanılabilir ve birleştirilebilir altyapı üzerine inşa ederek dünyanın dört bir yanındaki geliştiricilerle zekânın sınırlarını keşfetmeyi sabırsızlıkla bekliyoruz. Tüm Harness geliştiricilerini DSH eklenti ekosistemine katılmaya davet ediyoruz.",
  'welcomeContinue': 'Devam et',
  'welcomeError': 'Onay kaydedilemedi. Lütfen yeniden deneyin.',
  'onboardingTitle': 'Başlamak için bir API anahtarı ekleyin',
  'onboardingDescription': 'Geliştirmeye başlamak için resmi DeepSeek sağlayıcısını yapılandırın.',
  'onboardingLater': 'Daha sonra yapılandır',
