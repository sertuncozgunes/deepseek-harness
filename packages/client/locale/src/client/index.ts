...
import { en, tr, zh, type CommonKey } from '../locales/index.ts'
import {
  en as settingsEn, tr as settingsTr, zh as settingsZh, type SettingsLocaleKey,
...
export function apply(ctx: ClientContext): void {
  ...
  locale.register(COMMON_NS, { zh, en, tr })
  locale.register(SETTINGS_NS, { zh: settingsZh, en: settingsEn, tr: settingsTr })
