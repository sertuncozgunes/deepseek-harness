...
export const tr= {
  ...
  'hint.goal': 'uzun süren bir görev için hedefi açıklayın',
  'hint.goal.active': 'hedef etkin — edit / pause / resume / clear',
  'placeholder.plan': 'plan oluşturmak için görevinizi açıklayın',
  'placeholder.default': 'Mesaj yazın veya görev çalıştırın; / komutlar, @ dosyalar veya oturumlar',
  'placeholder.unavailable': 'Oturum kullanılamıyor',
  'placeholder.parentOffline': 'Üst oturum çevrimdışı; gönderim yapılamıyor ama çalışmayı yine de durdurabilirsiniz',
  'placeholder.hero': 'Ne oluşturmak istediğinizi anlatın; / komutlar, @ dosyalar veya oturumlar',
  'placeholder.workspace': 'Başlamak için bir çalışma alanı seçin',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter, kuyruktaki tüm mesajları araya girerek gönderir',
  'input.commands': 'Dosya ekle veya komut çalıştır',
  'input.file': 'Dosya',
  'input.stop': 'Üretimi durdur',
  'input.send': 'Mesaj gönder',
  'input.send.queue': 'Kuyruğa al',
  'input.send.steer': 'Araya girerek gönder',
  ...
  'attachment.dropTitle': 'Eklemek için dosya veya görselleri buraya sürükleyin',
  'attachment.dropDesc': 'Görsel sınırı: en fazla {count} görsel, her biri {size}',
  'attachment.dropBlocked': 'Şu an dosya veya görsel eklenemiyor',
  'image.pending': 'Bekleyen görseller',
  'image.openOriginal': 'Orijinali görüntüle',
  'image.openOriginalLabel': '{label}, orijinali görüntülemek için tıklayın',
  'image.remove': 'Görseli kaldır: {name}',
  'image.original': 'Orijinal görsel',
  'image.label': 'Görsel',
  'image.loadFailed': 'Görsel yüklenemedi; yeniden denemek için tıklayın',
  'image.loading': 'Görsel yükleniyor…',
  'image.preview': 'Orijinal görsel önizlemesi',
  'image.closePreview': 'Orijinal görsel önizlemesini kapat',
  'image.unsupportedType': 'Yalnızca PNG, JPG, WebP ve GIF görseller desteklenir',
  'image.tooMany': 'Bir mesaj en fazla {count} görsel içerebilir',
  'image.fileTooLarge': 'Her görsel {size} değerinden küçük olmalı',
  'image.totalTooLarge': 'Görseller toplamda {size} değerini aşıyor; bir kısmını kaldırıp yeniden deneyin',
  'image.tooManyPixels': 'Görsel çözünürlüğü çok yüksek; sıkıştırıp yeniden deneyin',
  'image.dimensionTooLarge': 'Görsel kenarları en fazla {size}px olmalı; küçültüp yeniden deneyin',
  'image.modelUnsupported': 'Geçerli model görselleri desteklemiyor; destekleyen bir modele geçin',
  'image.sendFailed': 'Görsel gönderilemedi ({reason}); yeniden ekleyip deneyin',
  'file.pending': 'Bekleyen dosyalar',
  'file.remove': 'Dosyayı kaldır: {name}',
  ...
  'file.stillUploading': 'Dosyalar hâlâ yükleniyor; bitince gönderin',
  'file.sessionUnavailable': 'Oturum kullanılamıyor; dosya yüklenemiyor',
  'file.notStaged': 'Dosyanın yüklemesi bitmedi; yeniden ekleyip deneyin',
  'file.label': 'Dosya',
  'context.aria': 'Bağlamın {percent} kadarı kullanıldı',
  'context.used': 'bağlam kullanıldı',
  'context.system': 'Sistem istemi',
  'context.tools': 'Araç tanımları',
  'context.messages': 'Mesajlar',
  'settings.enter.title': 'Meşgulken gönderme davranışı',
  'settings.enter.description': 'Ajan çalışırken Enter ve Gönder düğmesinin davranışı; Cmd/Ctrl+Enter diğer davranışı kullanır',
  'settings.enter.queue': 'Kuyruğa al',
  'settings.enter.steer': 'Araya gir',
  'access.preset.readOnly': 'Salt okunur',
  'access.preset.workspaceWrite': 'Çalışma alanı yazımı',
  'access.preset.fullAccess': 'Tam erişim',
  'access.confirm.title': 'Tam erişim etkinleştirilsin mi?',
  'access.confirm.description': 'Tam erişim, onay adımlarını azaltır ve ajanın hassas işlemler, dosya değişiklikleri ya da harici komutlar dahil daha fazla eylemi doğrudan gerçekleştirmesine olanak tanır. Yalnızca geçerli göreve güvendiğinizde kullanın.',
  'access.confirm.acknowledge': 'Riskleri anlıyorum ve devam etmek istiyorum',
  'access.confirm.cancel': 'Vazgeç',
  ...
  'todo.rowTitle': 'Görev listesini güncelle',
  'todo.completed': '{done}/{total} tamamlandı',
  'command.attachmentsUnsupported': '/{command} ek kabul etmiyor; önce ekleri kaldırın',
  'ask.rowTitle': 'Soru sor',
  'ask.waiting': 'bekleniyor',
  'ask.cancelled': 'iptal edildi',
  'ask.cancelledDetail': 'Bu soru grubu, yanıtlar gönderilmeden önce iptal edildi.',
  'ask.interrupted': 'kesildi',
  'ask.interruptedDetail': 'Bu soru grubu, yanıtlar gönderilmeden önce kesildi.',
  ...
  'row.output': 'ÇIKTI',
  'row.inspect': 'İncele',
  'tool.title.search': 'Ara',
  'tool.title.read': 'Oku',
  'tool.title.bash': 'Bash',
  'tool.title.write': 'Yaz',
  'tool.title.edit': 'Düzenle',
  'tool.title.code': 'Kod',
  ...
  'tool.title.pwsh': 'Pwsh',
  'tool.title.readImage': 'Görseli oku',
  'tool.title.grep': 'Grep',
  'tool.title.glob': 'Glob',
  'tool.title.webSearch': 'Web araması',
  'tool.title.webFetch': 'Sayfa getir',
  'diff.files.one': '{count} dosya',
  'diff.files.other': '{count} dosya',
  'diff.collapseAria': 'Farkı daralt',
  'diff.expandAria': '{count} satır daha fazla farkı genişlet',
  'diff.expandRest': '… {count} satır daha',
  'read.window': '{shown} / {total} satır gösteriliyor',
  'read.collapseAria': 'İçeriği daralt',
  'read.expandAria': '{count} satır daha genişlet',
  'read.expandRest': '… {count} satır daha',
  'search.paths': '{shown} yol',
  'search.paths.truncated': '{shown} / {total} yol gösteriliyor',
  'search.matches': '{shown} eşleşme · {files} dosya',
  'search.matches.truncated': '{shown} / {total} eşleşme gösteriliyor · {files} dosya',
  'search.noResults': 'Sonuç yok',
  'search.collapseAria': 'Sonuçları daralt',
  'search.expandAria': '{count} sonuç satırı daha genişlet',
  'search.expandRest': '… {count} satır daha',
  'web.noResults': 'Sonuç bulunamadı',
  'web.sourcesTruncated': 'Kaynak listesi kısaltıldı',
  'web.http': 'HTTP',
  'web.contentTruncated': 'İçerik kısaltıldı',
  'details.running': 'Çalışıyor…',
  'queue.count': '{n} kuyrukta mesaj',
  'queue.sending': 'Gönderiliyor…',
  'queue.image': 'Kuyruktaki mesaj görseli',
  'queue.file': 'Kuyruktaki dosya: {name}',
  'queue.edit': 'Kuyruktaki mesajı düzenle',
  'queue.edit.unsupported': 'Metin olmayan içerik var; düzenleme henüz desteklenmiyor',
  'queue.save': 'Kuyruktaki mesajı kaydet',
  'queue.cancelEdit': 'Düzenlemeyi iptal et',
  'queue.remove': 'Kuyruktaki mesajı kaldır',
  'queue.steer': 'Kuyruktaki mesajı araya girerek gönder',
  'queue.steer.unavailable': 'Araya girerek gönderme yalnızca ajan çalışırken kullanılabilir',
  'queue.editFailed': 'Düzenleme başarısız: bu mesaj gönderilmeye başlamış olabilir.',
  'queue.removeFailed': 'Kaldırma başarısız: bu mesaj gönderilmeye başlamış olabilir.',
  'queue.steerFailed': 'Araya girerek gönderme başarısız. Yeniden deneyin.',
  ...
  'terminal.noOutput': 'Çıktı yok',
  'terminal.collapseAria': 'Çıktıyı daralt',
  'terminal.expandAria': 'Kalan {n} çıktı satırını genişlet',
