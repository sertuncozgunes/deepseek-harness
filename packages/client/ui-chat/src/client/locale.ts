...
export const zh = {
  ...
  'stats.tab.title': '统计',
  'stats.tab.guide': '会话全程的轮次、耗时与 token 用量',
  'stats.tab.empty': '本会话还没有统计数据。',
...
export const en = {
  ...
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
  'stats.tab.title': 'Stats',
  'stats.tab.guide': 'Session-wide turn counts, timings, and token usage',
  'stats.tab.empty': 'No stats for this session yet.',
...
export const tr= {
  ...
  'stats.dialog.llmTime': 'Model süresi',
  'stats.dialog.toolTime': 'Araç süresi',
  'stats.dialog.ttft': 'İlk tokena ortalama süre (TTFT)',
  'stats.dialog.speed': 'Saniyedeki token sayısı (TPS)',
  ...
  'chat.deepDiving': 'Derinlemesine araştırılıyor…',
  'chat.turnNavigation.label': 'Tur gezinmesi',
  'chat.turnNavigation.jump': 'Tura atla: {turn}',
  'chat.turnNavigation.jumpLoad': 'Yükle ve tura atla: {turn}',
  'chat.turnNavigation.turn': '{turn}. tur',
  ...
  'message.systemPromptUpdate': 'Sistem istemi güncellemesi',
  'message.contextInjection': 'Bağlam enjeksiyonu',
  'message.contextRecall': 'Oturum geri çağırma',
  'message.referenceSummary': 'Atıf yapılan oturum · {labels}',
  'message.referenceSeparator': ', ',
  ...
  'message.context.catalog.replaced': 'Yedek katalog',
  'message.context.catalog.more': '… {count} tane daha',
  'message.context.snapshot.supersedes': 'Önceki anlık görüntülerin yerine geçer',
  'message.context.relay.from': '{session} oturumundan',
  'message.context.recall.counts': '{retained} korundu · {omitted} atlandı',
  'message.context.recall.truncated': 'kısaltıldı',
  ...
  'message.compaction.commandTitle': 'compact',
  'message.think': 'Düşün',
  'message.unknownSurface': 'Bilinmeyen yüzey olayı: {type}',
  ...
  'message.turnProcess.messages.one': '{count} mesaj',
  'message.turnProcess.messages.other': '{count} mesaj',
  ...
  'message.branch': 'Yeni konuşmada dallandır',
  'message.branchUnavailable': 'Yalnızca tamamlanmış bir turun son mesajında kullanılabilir',
  ...
  'message.retry.scheduled': 'Model isteğinin yeniden denenmesi bekleniyor',
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds} sn',
  ...
  'message.maxTokens': 'Çıktı token sınırına ulaşıldı',
  'message.maxTokens.hint': 'Yanıt kesildi; önceki çıktı konuşmada korunuyor. Modelin devam etmesi için "devam et" gönderin.',
  'message.ranFor': '{duration} sürdü',
  'message.tokensPerSecond': '{tps} tok/sn',
  'message.turnUsage.title': 'Tur kullanımı',
  ...
  'message.turnUsage.input': 'Önbelleksiz girdi',
  'message.turnUsage.cacheRead': 'Önbellekli girdi',
  'message.turnUsage.cacheWrite': 'Önbellek yazma',
  'message.turnUsage.output': 'Çıktı',
  'message.turnUsage.reasoning': ' ({tokens} düşünme)',
  'message.turnUsage.count': '{count} tok',
  'message.turnTime.title': 'Tur süresi ve hızı',
  'message.turnTime.duration': 'Toplam çalışma süresi',
  'message.turnTime.speed': 'Saniyedeki token sayısı (TPS)',
  'message.turnTime.ttft': 'İlk tokena kadar geçen süre (TTFT)',
  'duration.seconds': '{seconds} sn',
  'duration.minutes': '{minutes} dk {seconds} sn',
  'duration.hours': '{hours} sa {minutes} dk {seconds} sn',
  ...
  'json.truncated': '… kısaltıldı, toplam {total} karakter',
  'clock.md': '{d}.{m}',
  'clock.ymd': '{d}.{m}.{y}',
  'stats.tab.title': 'İstatistikler',
  'stats.tab.guide': 'Oturum genelinde tur sayıları, süreler ve token kullanımı',
  'stats.tab.empty': 'Bu oturum için henüz istatistik yok.',
}
