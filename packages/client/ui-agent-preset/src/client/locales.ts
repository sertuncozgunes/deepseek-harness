...
export const tr: Record<AgentPresetSettingsKey, string>= {
  'error': 'Ajan ön ayarları yüklenemedi.',
  'userTrust': 'Özel',
  'seatHint': 'Başlatmak üzere olduğunuz oturumun ajan ön ayarı',
  'headerHint': 'Bu oturumun çalıştığı ajan ön ayarı; oturum başlarken sabitlendi',
  'nav': 'Ajan ön ayarları',
  'sectionIntro': 'Ön ayar, bir oturumun ajanının çalıştırdığı eklenti kompozisyonudur — araçları, istemi ve yetenekleri. Mevcut bir ön ayarı kopyalayıp kendinize uyarlayın ya da Creator modunda ajanın sizin için bir taslak oluşturmasını sağlayın.',
  'builtIn': 'Yerleşik',
  'setDefault': 'Varsayılan yap',
  'view': 'Görüntüle',
  'presetStandardName': 'Standart mod',
  'presetStandardDescription': 'Dosya düzenleme, kabuk, dosya ve web araması, beceriler, planlama, hedefler, alt ajanlar ve iş akışlarıyla eksiksiz kodlama ajanı.',
  'presetPtcName': 'PTC modu',
  'presetPtcDescription': "İş akışı aracı olmayan eksiksiz kodlama ajanı; diğer araçlar PTC modu SDK'sı üzerinden sunulur, böylece model çok adımlı işlemleri tek bir TypeScript programında birleştirebilir.",
  'presetMinimalName': 'Minimal mod',
  'presetMinimalDescription': 'Kalıcı kabuğu olan tek araçlı kodlama ajanı.',
  'presetCordisName': 'Creator modu',
  'presetCordisDescription': 'Özel ajan ön ayarları oluşturmak için: Standart modun tüm yetenekleriyle birlikte çalışma zamanı incelemesi, eklenti deneyleri ve ön ayar yazma rehberliği sunar.',
  'duplicate': 'Kopyala',
  'duplicateUnavailable': 'Bu dağıtımda yazılabilir ön ayar klasörü yok',
  'delete': 'Sil',
  'presetId': 'Tanımlayıcı',
  'presetIdPlaceholder': 'my-agent',
  'displayName': 'Ad',
  'displayNamePlaceholder': 'Seçicide görünen ad; boşsa tanımlayıcı kullanılır',
  'inUse': 'Kullanımda',
  'selectionOffDefault': 'Varsayılan',
  'builtInGroup': 'Yerleşik',
  'customGroup': 'Özel',
  'noDescription': 'Açıklama yok.',
  'brokenBadge': 'Yüklenemedi',
  'brokenNoCopy': 'Yüklenemeyen bir ön ayar kopyalanamaz',
  'switchRefused': '{name} ön ayarına geçilemedi: {reason}',
  'copyOf': 'Kopyalandığı kaynak',
  'composition': 'Kompozisyon (agent.cordis.yml)',
  'cancel': 'Vazgeç',
  'close': 'Kapat',
  'retry': 'Yeniden dene',
  'copyTitle': 'Ön ayarı kopyala',
  'copyIntro': 'Ön ayarın tamamı bu makineye kopyalanır. Tanımlayıcı, klasör adı olur ve sonradan değiştirilemez; geri kalan her şey ön ayarın kendi dosyalarında düzenlenir.',
  'create': 'Oluştur',
  'creating': 'Oluşturuluyor…',
  'creatorDraft': 'Creator moduyla özel bir ön ayar taslağı çıkar',
  ...
  'idInvalid': 'Küçük harf, rakam ve kısa çizgi kullanın; harf veya rakamla başlayın.',
  'idTaken': 'Bu tanımlayıcıya sahip bir ön ayar zaten var.',
  'deleteTitle': 'Bu ön ayar silinsin mi?',
  'deleteDescription': 'Ön ayar klasörü silinir. Üzerinde çalışan oturumlar etkilenmez; yeni oturumlar onu seçemez.',
  'deleteConfirm': 'Sil',
  'deleting': 'Siliniyor…',
  'showPicker': 'Ajan modları arasında geçişe izin ver',
  'showPickerBeta': 'Beta',
  'showPickerDescription': 'Açıkken, yeni görevler Standart, PTC, Creator, Minimal ve özel modlar arasından seçim yapabilir. Kapalıyken tüm yeni görevler varsayılan modu kullanır (varsayılan Standart; yapılandırılabilir). Yalnızca yeni görevleri etkiler.',
  'enablePickerToSetDefault': 'Varsayılan seçmek için Ajan modu seçimini açın',
  'enablePickerToCreate': 'Creator modunu başlatmak için Ajan modu seçimini açın',
}
