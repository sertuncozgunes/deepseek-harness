...
import { tr,  en, zh, type AgentPresetSettingsKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { zh, en, tr }), 'ui-agent-preset: settings row dictionaries')
