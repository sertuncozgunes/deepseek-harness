...
export const tr: Record<TrajectoryKey, string>= {
  'view.trajectory': 'Yörünge',
  'toolbar.aria': 'Yörünge araç çubuğu',
  'toolbar.duration': 'Süre',
  'toolbar.useActualDuration': 'Gerçek süreyi kullan',
  'toolbar.useEqualWidth': 'Eşit genişlikli işlemler kullan',
  'toolbar.actualTime': 'Gerçek zaman',
  'toolbar.turns': 'Turlar',
  'toolbar.expandTurns': 'Tüm turları genişlet',
  'toolbar.collapseTurns': 'Tüm turları daralt',
  'toolbar.calls': 'Çağrılar',
  'toolbar.expandCalls': 'Tüm çağrıları genişlet',
  'toolbar.collapseCalls': 'Tüm çağrıları daralt',
  'toolbar.search': 'Yörüngede ara',
  'toolbar.searchPlaceholder': 'Ara',
  'kind.system': 'SİSTEM',
  'kind.user': 'KULLANICI',
  'kind.context': 'BAĞLAM',
  'kind.compacted': 'SIKIŞTIRILMIŞ',
  'kind.message': 'Mesaj',
  'kind.assistant': 'ASİSTAN',
  'kind.tool': 'ARAÇ',
  ...
  'turn.label': 'Tur {turn}',
  'section.betweenTurns': 'Turlar arası',
  'group.message': 'Mesaj',
  ...
  'timing.stepStartUnavailable': 'Adım başlangıcı kullanılamıyor',
  'timing.firstTokenUnavailable': 'İlk token kullanılamıyor',
  'timing.usageUnavailable': 'Kullanım verisi kullanılamıyor',
  'timing.outputTokensUnavailable': 'Çıktı token sayısı kullanılamıyor',
  ...
  'unit.tokensPerSecond': '{value} tok/s',
  'usage.tokens': 'Token',
  'usage.reasoning': 'Düşünme',
  'usage.content': 'İçerik',
  'usage.notReported': 'Kullanım raporlanmadı',
  'usage.input': 'Girdi',
  'usage.cached': 'Önbellekten okunan',
  'usage.cacheCreated': 'Önbelleğe yazılan',
  'usage.other': 'Diğer',
  'usage.output': 'Çıktı',
  'usage.thisRequest': 'Bu istek',
  'usage.sessionCumulative': 'Oturum toplamı',
  ...
  'source.goal': 'Hedef',
  'source.goalRound': 'Hedef · Round {round}',
  'source.notRecorded': 'Kaynak kaydedilmedi',
  'source.messageJson': 'Mesaj kaynağı JSON',
  'tab.summary': 'Özet',
  ...
  'tab.diff': 'Fark',
  'tab.systemPrompt': 'Sistem İstemi',
  'tab.tools': 'Araçlar',
  'tab.options': 'Seçenekler',
  'tab.usage': 'Kullanım',
  'record.toolCallOnly': '(yalnızca araç çağrısı)',
  'record.noContent': 'İçerik yok',
  'record.noPayload': 'Payload yakalanmadı',
  ...
  'record.json': 'JSON',
  'record.parametersJson': 'Parametreler JSON',
  'record.namedParametersJson': '{name} parametreleri JSON',
  'record.payloadJson': 'Payload JSON',
  ...
  'record.systemPrompt': 'Sistem İstemi',
  'record.tools': 'Araçlar',
  'block.openSummary': 'Blok #{index} araç çağrısı özetini aç',
  'block.openSummaryTitle': 'Araç çağrısı özetini aç',
  'block.label': 'Blok #{index} {type}',
  'history.loadingTrajectory': 'Yörünge yükleniyor…',
  'history.loadingEarlier': 'Daha eski geçmiş yükleniyor…',
  'history.loadingEarlierAria': 'Daha eski geçmiş yükleniyor…',
  'history.loadEarlier': 'Daha eski geçmişi yükle',
  'history.clickToLoadEarlier': 'Daha eski geçmişi yüklemek için tıkla',
  ...
  'details.resize': 'Olay ayrıntılarını yeniden boyutlandır',
  'details.resizeTitle': 'Yeniden boyutlandırmak için sürükle. Sıfırlamak için çift tıkla.',
  ...
  'details.compacted': 'Sıkıştırıldı',
  'details.assistantMessage': 'Asistan Mesajı',
  'details.source': 'Kaynak',
  'details.hierarchy': 'Hiyerarşi',
  'details.toolCall': 'Araç Çağrısı',
  'timeline.aria': 'Yörünge zaman çizelgesi',
  'timeline.overviewAria': 'Zaman çizelgesi genel görünümü; olaylara odaklanmak için yatay sürükle',
  'timeline.noTimingData': 'Zamanlama verisi yok',
  'timeline.total': 'Toplam {duration}',
  'timeline.started': 'Başlangıç {time}',
  'timeline.ttftDecoding': 'TTFT {ttft} · Çözümleme {decoding}',
  'layout.compacting': 'Bağlam sıkıştırılıyor…',
  'layout.compactionFailed': 'Sıkıştırma başarısız',
  'layout.compacted': 'Bağlam sıkıştırıldı',
  'layout.toolCallOnly': 'Yalnızca araç çağrısı',
  'layout.imageOnly': 'Görsel ×{count}',
  'layout.fileAttachments': 'Dosya ×{count}',
  'layout.initialSystemPrompt': 'Başlangıç Sistem İstemi',
  'layout.systemPromptUpdated': 'Sistem İstemi Güncellendi',
  'layout.toolsUpdated': 'Araçlar Güncellendi',
  'layout.systemPromptAndToolsUpdated': 'Sistem İstemi ve Araçlar Güncellendi',
  'layout.compactionInterrupted': 'Sıkıştırma tamamlanmadan kesintiye uğradı.',
}
