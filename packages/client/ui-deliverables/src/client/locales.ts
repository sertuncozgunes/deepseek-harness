...
export const tr: Record<DeliverablesKey, string>= {
  'presented.nativeUnavailable': 'Bu dosyanın kullanılabilir bir Host yolu yok. Kenar çubuğunda önizleyin.',
  'presented.revealError': 'Dosya yöneticisinde gösterilemedi. Yeniden deneyin.',
  'presented.directoryError': 'İçeren klasör açılamadı. Yeniden deneyin.',
  'presented.directoryOpening': 'İçeren klasör açılıyor…',
  'presented.directoryOpened': 'İçeren klasörün açılması istendi',
  'presented.revealed': 'Dosya yöneticisinde gösterilmesi istendi',
  'presented.revealing': 'Dosya yöneticisinde gösteriliyor…',
  'presented.unavailable': 'Bu Host üzerinde dosya veya klasör açacak bir masaüstü yok',
  'presented.retry': 'Yeniden dene',
  'presented.hostError': 'Host masaüstü bilgileri okunamadı',
  'presented.directory': 'İçeren klasörü aç',
  ...
  'presented.more': '{name} için diğer dosya işlemleri',
  'presented.action': 'Aç',
  'presented.preview': 'Kenar çubuğunda önizle',
  'presented.previewButton': '{name} dosyasını kenar çubuğunda aç',
  'presented.previewCard': '{name} dosyasını kenar çubuğunda önizle',
  'presented.all': 'Tüm {count} dosya',
  'presented.expandAria': 'Tüm {count} teslim edilen dosyayı göster',
  'presented.collapse': 'Daralt',
  'presented.collapseAria': 'Teslim edilen dosyaları daralt',
