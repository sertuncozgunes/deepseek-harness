...
export const tr: Record<SubagentKey, string>= {
  'diagnostic.corrupt': 'bozuk oturum kaydı',
  'diagnostic.unsupported': 'desteklenmeyen alt ajan kayıt sürümü',
  ...
  'duration.years': '~{years} yıl',
  'duration.yearsMonths': '~{years} yıl {months} ay',
  'duration.exactDays': '{days} g {hours} sa {minutes} dk {seconds} sn',
  'duration.exactTitle': 'Toplam aktif süre: {duration}',
  'tokens.thousand': '{value} B',
  'tokens.million': '{value} M',
  'tokens.total': '{value} tok',
  'loading.label': 'Alt ajanlar yükleniyor…',
  'loading.aria': 'Alt ajanlar yükleniyor',
  'load.error': 'Alt ajanlar yüklenemedi',
  'retry': 'Yeniden dene',
  'mode.oneShot': 'tek seferlik',
  'mode.continuable': 'devam edilebilir',
  'activity.running': 'çalışıyor',
  'activity.inactive': 'çalışmıyor',
  'branch.collapse': '{label} alt ajanlarını daralt',
  'branch.expand': '{label} alt ajanlarını genişlet',
  'count.total.one': '{count} alt ajan',
  'count.total.other': '{count} alt ajan',
  'count.running.one': '{count} alt ajan çalışıyor',
  'count.running.other': '{count} alt ajan çalışıyor',
  'switcher.aria': 'Alt ajanı değiştir: {title}',
  'tree.aria': 'Alt ajan oturumları',
  'readonly.oneShot.title': 'Tek seferlik alt ajan kaydı',
  'readonly.title': 'Bu alt ajan şu an salt okunur',
  'readonly.oneShot.body': 'Tek seferlik görevler devam mesajı kabul etmez; tüm yürütme kaydını buradan inceleyebilirsiniz.',
  'readonly.body': 'Üst oturum çevrimdışı; mesaj göndermeye devam etmek için yeniden açın.',
}
