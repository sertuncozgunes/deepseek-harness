...
import {
  accessEn, accessTr, accessZh, en, tr, zh,
} from './locales.ts'
import {
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => {
    const disposers = [
      ...
      ctx.locale.register(ACCESS_NS, 'tr', {
        'preset.readOnly': accessTr['preset.readOnly'],
        'preset.workspaceWrite': accessTr['preset.workspaceWrite'],
        'preset.fullAccess': accessTr['preset.fullAccess'],
        'confirm.title': accessTr['confirm.title'],
        'confirm.description': accessTr['confirm.description'],
        'confirm.acknowledge': accessTr['confirm.acknowledge'],
        'confirm.cancel': accessTr['confirm.cancel'],
        'confirm.enable': accessTr['confirm.enable'],
      }),
    ]
  ...
  ctx.effect(() => ctx.locale.register('settings.permission', { zh, en, tr }), 'ui-permission: settings row dictionaries')
